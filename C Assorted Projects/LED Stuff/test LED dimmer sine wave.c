...
void sine_parse(void)
{
	if(sinCounter >= 10)
	{
		...
		if(sinDegree > 23)
		{
			pWidthBlue = sineFunction[sinDegree-23];
		}
		else
		{
			pWidthBlue = sineFunction[sinDegree+12];
		}
		if(sinDegree > 11)
		{
			pWidthGreen = sineFunction[sinDegree-11];
		}
		else
		{
